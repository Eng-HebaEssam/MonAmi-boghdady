    ...
    <div class="main-panel ">
        <div class="content-wrapper ">
            ...
            <?php 
                ...
                $stmt = $con->prepare("SELECT * FROM members  ORDER BY userid DESC");
                $stmt->execute();
                $rows = $stmt->fetchAll();
                if (! empty($rows)) {
            ?>
                                    ...
                                    <?php
							            foreach($rows as $row) {?>
                                            <tr>
                                                ...
                                                <td> <?php 
                                                    if( $row['groupid']== 1){
                                                        echo 'الصف الاول الاعدادى';
                                                    } elseif( $row['groupid']== 2){
                                                        echo 'الصف الثاني الاعدادى';
                                                    } elseif( $row['groupid']== 3){
                                                        echo 'الصف الثالث الاعدادى';
                                                ...
                                                <td>
                                                    ...
                                                    <?php  if($row['regstatus']== 0){echo'<button type="button " class="btn btn-outline-primary btn-sm activiate" data-toggle="modal" data-target="#activiate">تفعيل</button>';} ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
